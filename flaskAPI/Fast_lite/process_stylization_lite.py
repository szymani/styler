...
from Fast_lite.smooth_filter import smooth_filter
...
def stylization(stylization_module, smoothing_module, content_image, style_image, cuda, no_post, cont_seg_remapping=None, styl_seg_remapping=None):
    # Load image
    with torch.no_grad():
        ...
        out_byte = BytesIO()
        out_img.save(out_byte, format='PNG')
        out_byte = out_byte.getvalue()
